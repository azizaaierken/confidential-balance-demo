...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary:
    "bg-brand-600 text-white hover:bg-brand-700 focus-visible:outline-brand-600 disabled:bg-ink-400",
  secondary:
    "bg-white text-ink-700 border border-border-strong hover:bg-canvas focus-visible:outline-brand-600 disabled:text-ink-400",
  ghost:
    "bg-transparent text-ink-700 hover:bg-ink-900/5 focus-visible:outline-brand-600 disabled:text-ink-400",
  danger:
    "bg-danger-500 text-white hover:bg-danger-600 focus-visible:outline-danger-500 disabled:bg-ink-400",
};
